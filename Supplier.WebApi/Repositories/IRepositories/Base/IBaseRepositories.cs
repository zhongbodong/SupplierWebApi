...
namespace Repositories.IRepositories.Base
{
    public interface IBaseRepository<TEntity> where TEntity : class
    {
        ...
        /// <returns></returns>
        Task<List<TEntity>> SqlQuery(string sql, Expression<Func<TEntity, bool>> whereExpression, int intPageIndex, int intPageSize);
