...
namespace LogicHandlers.LogicHandlers.Base
{
    public class BaseLogicHandler<TEntity, TRepository> : IBaseLogicHandler<TEntity>
        where TEntity : class, new()
         where TRepository : IBaseRepository<TEntity>
    {
        protected TRepository Repository;

        public BaseLogicHandler(TRepository Repository)
        {
        ...
        public async Task<TEntity> QueryById(object objId, bool blnUseCache = false)
        {
            ...
            return await Repository.QueryById(objId, blnUseCache);
        }
        ...
        public async Task<List<TEntity>> QueryByIDs(object[] lstIds)
        {
            ...
            return await Repository.QueryByIDs(lstIds);
        }
        ...
        {
            return await Repository.Add(entity, insertColumns);
        }
        ...
        {
            // Repository.Tran<Task<int>>(() => Repository.AddMany(listEntity));//用事务进行批量插入
            return await Repository.AddMany(listEntity);
        }
        ...
        {
            return await Repository.Query(strWhere, strOrderByFileds);
        }
        ...
        {
            return await Repository.QueryTopN(whereExpression, intTop, strOrderByFileds);
        }
        ...
        {
            return await Repository.QueryMuch(joinExpression, selectExpression, whereLambda);
        }
    }
}
